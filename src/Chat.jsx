  ...
  return (
    <>
      <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
        <div class="flex sm:items-center px-2 md:px-0  justify-between py-3 border-b-2 border-gray-200">
            <div class="relative flex items-center space-x-4">
              ...
              <div class="flex flex-col leading-tight">
                  <div class="text-2xl mt-1 flex items-center">
                    <span class="text-gray-700 mr-3">Shadow Chat</span>
                  </div>
              </div>
            </div>
        ...
        <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <form class="relative flex" onSubmit={addMessage}>
              ...
              <input type="text" value={message} placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-3 bg-gray-200 rounded-md py-3" onChange={e => setMessage(e.target.value)}/>
